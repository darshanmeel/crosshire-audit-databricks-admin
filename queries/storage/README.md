...
| 08 | [`table_inventory_type`](https://learn.crosshire.ch/learn/tech/databricks/audit#q-table_inventory_type) | A catalog/schema-level census of every table and view the collector can see, counted by managed/external/view type and by data source format. |
