...
> 📖 **Guided HTML tour:** [`docs/index.html`](../../docs/index.html) explains the library query-by-query — why it matters, what it does in plain terms, how to read every output column, sample output, and caveats. From this domain: [`lakeflow_jobs_on_all_purpose`](../../docs/index.html#q-lakeflow_jobs_on_all_purpose), [`lakeflow_failed_jobs_wasted_dbus`](../../docs/index.html#q-lakeflow_failed_jobs_wasted_dbus). *(Phase 1 = top 10; more in phases.)*
