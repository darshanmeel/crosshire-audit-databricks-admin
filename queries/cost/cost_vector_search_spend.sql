...
-- next: cost_by_serving_endpoint (for the raw, non-dollarized MODEL_SERVING + VECTOR_SEARCH usage), compute_serving_dormant_endpoints (to check whether a CRITICAL endpoint is actually receiving traffic before you shrink it)
