...
-- next: cost_by_serving_endpoint (for the raw, non-dollarized per-endpoint usage split by usage_type), compute_serving_dormant_endpoints (to check whether a CRITICAL endpoint is actually seeing real traffic)
